            ...
            <div class="row">
                ...
                <div class=""> 
                    <div id="emaildiv1">                        
                        ...
                        <div class="col-sm-8">   
                            <?php echo form_input(array('type'=>'email', 'name' => 'emailadresV', 'id' => 'emailadres1', 'class' => 'form-control')); ?>                    
                        </div>
                    </div>
                    ...
                    <div id="password1div1"> 
                        <?php echo form_label('Wachtwoord:', 'password', array('class' => 'col-sm-4 control-label')); ?>    
                        <div class="col-sm-8">                       
                            <?php echo form_password(array('name' => 'wachtwoord1V', 'id' => 'password11', 'class' => 'form-control')); ?> 
                        </div>
                    </div>
                    ...
                    <div id="password2div1">
                        ...
                        <div class="col-sm-8">                                        
                            <?php echo form_password(array('name' => 'bevestigwwV', 'id' => 'password21', 'class' => 'form-control')); ?>                    
                        </div>
                    </div>
                    ...
                    <div id="voornaamdiv1">
                        ...
                        <div class="col-sm-8">   
                            <?php echo form_input(array('name' => 'voornaamV', 'id' => 'voornaam1', 'class' => 'form-control')); ?>                                        
                        </div>
                    </div>
                    ...
                    <div id="familienaamdiv1">
                        ...
                        <div class="col-sm-8">  
                            <?php echo form_input(array('name' => 'familienaamV', 'id' => 'familienaam1', 'class' => 'form-control')); ?>                                        
                        </div>
                    </div>
