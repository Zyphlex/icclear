                                ...
                                foreach ($planningen as $planning) {
                                    if ($dag->conferentiedag->id == $planning->conferentiedag->id && $planning->conferentiedag->conferentieId == $actieveId->id) {
                                        ...
                                        <tr>
                                            ...
                                            <td><span class="glyphicon glyphicon-user link-icon"></span><a href="" data-toggle="modal" class="toonSpreker" data-id="<?php echo $planning->spreker->id ?>"> <?php echo $planning->spreker->voornaam . ' ' . $planning->spreker->familienaam ?></a></td>
                                        </tr> 
                                        <?php
                                    }
                                }
