        ...
        <div class="modal-content">
            ...
            <div class="modal-body">                  
                ...
                <form id="JqAjaxForm">
                    ...
                    <p><?php echo form_input(array('name' => 'beginuur', 'id' => 'beginuur', 'class' => 'form-control', 'type' => 'time','required')); ?></p>

                    <p><?php echo form_label('Einduur:', 'einduur'); ?></p>
                    <p><?php echo form_input(array('name' => 'einduur', 'id' => 'einduur', 'class' => 'form-control', 'type' => 'time','required')); ?></p>
                    ...
                    <p>
                        <?php echo form_radio(array('name' => 'plenair', 'class' => 'form-horizontal', 'value' => '1','required')); ?> Ja
                        <?php echo form_radio(array('name' => 'plenair', 'class' => 'form-horizontal', 'value' => '0','required')); ?> Nee
                    </p>
                </form>
