                ...
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <?php foreach ($gebruikers as $gebruiker) { ?>
                            ...
                            <a data-href="" data-toggle="modal" data-target="#confirm-delete" class="btn btn-default" href="#">Verwijderen</a>
                            <a href="https://subversion.khk.be/projecten/TI1415project23/icclear/icclear.php/gebruiker/verwijder/<?php $gebruiker->id?>" class="btn btn-danger danger">Verwijder</a>
                            </tr>
                        <?php } ?>
                    </div>
                </div>
